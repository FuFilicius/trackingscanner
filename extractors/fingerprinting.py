...
from scanner_tools.results import (
    FingerprintingCall,
...
class FingerprintingExtractor(Extractor):
    def register_javascript(self) -> str:
    ...
    def extract_information(self) -> None:
        ...
        fingerprinting_summary: FingerprintingSummary = {
            "canvas": canvas,
            "webGL": webgl,
            "webRTC": webrtc
        }
        self.result["fingerprinting"] = fingerprinting_summary

    def _read_logs_from_local_storage(self) -> list[dict[str, object]]:
        merged_logs: list[dict[str, object]] = []
    ...
    @staticmethod
    def _extract_logs_from_storage(local_storage: object) -> list[dict[str, object]]:
